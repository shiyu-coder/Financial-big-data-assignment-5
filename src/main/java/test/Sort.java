...
public class Sort {
    ...
    public static class Reduce extends
        ...
        private static TreeMap<WCString, String> tm = new TreeMap<WCString, String>(new Comparator<WCString>(){
            /**
             ...
             * @return
             */
            public int compare(WCString o1, WCString o2) {
        ...
        protected void reduce(IntWritable key, Iterable<Text> values,
            ...
            for (Text text : values) {
                ...
                tm.put(new WCString(key.get(), text.toString()),text.toString());
        ...
        protected void cleanup(Context context)
            ...
            Set<Entry<WCString, String>> set = tm.entrySet();
            int count = 1;
            for (Entry<WCString, String> entry : set) {
